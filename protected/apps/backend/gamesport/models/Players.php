...
class Players extends CFormModel {
    ...
    public function getItemspPlayer($cid = null) {
        $obj_tblTournament = YiiTables::getInstance(TBL_GS_PLAYERS);
    ...
    function ListPlayers($tourID="0",$field = "*", $conditions = null, $orderBy = "", $limit = 10, $start = 0){
