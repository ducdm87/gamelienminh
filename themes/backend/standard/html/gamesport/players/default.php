                    ...
                    <tbody>
                        ...
                        if (isset($items) && $items) {
                            foreach ($items as $i => $item) {
                                $link_edit = Router::buildLink("gamesport", array('view'=>'players', 'layout' => 'edit', "cid" => $item['id']));
                             //   $item['name'] = str_repeat("&nbsp; &nbsp; &nbsp; &nbsp; ", $item['level'] -  1 ) . " - " . $item['name'];
                                $link_items = Router::buildLink('gamesport', array('view'=>'players','filter_cid'=>$item['id'])); 
                                ?>
                                <tr>
                                    <td><?php echo $k + 1; ?></td>                                        
                                    <td>
