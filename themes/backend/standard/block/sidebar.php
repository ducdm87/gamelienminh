<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav minimize hide"> </ul>
        <ul class="nav navbar-nav navbar-right navbar-user">
            <?php if (getSysConfig("sidebar.display", 1) == 1) { ?>
                ...
                <li class="dropdown <?php if ($app == "locations") echo "active "; ?>">
                    <a href="#" class="dropdown-toggle parent" data-toggle="dropdown">
                        <i class="fa fa-caret-square-o-down"></i> Tools 
                        <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <?php echo showSideBarMenu("locations", "", "Locations"); ?>
                    </ul>
                </li> 
